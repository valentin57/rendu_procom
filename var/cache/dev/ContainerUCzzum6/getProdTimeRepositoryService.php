...
// Returns the private 'App\Repository\ProdTimeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProdTimeRepository.php';

return $this->privates['App\Repository\ProdTimeRepository'] = new \App\Repository\ProdTimeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
