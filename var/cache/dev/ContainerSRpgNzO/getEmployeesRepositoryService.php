...
// Returns the private 'App\Repository\EmployeesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EmployeesRepository.php';

return $this->privates['App\Repository\EmployeesRepository'] = new \App\Repository\EmployeesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
